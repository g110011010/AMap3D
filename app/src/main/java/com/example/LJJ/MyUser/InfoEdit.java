...
public class InfoEdit extends AppCompatActivity {
        ...
        public void onClick(View v) {
            ...
            Handler handler=new Handler(){
                ...
                public void handleMessage(Message msg) {
                    ...
                    if(true){
                        app.getUser().setAccount(account.getText().toString());
                        app.getUser().setPassword(password.getText().toString());
                        app.getUser().setNickname(nickname.getText().toString());
                    }
                }
    ...
    public void initviews(){
        ...
        listAdapter la=new listAdapter(InfoEdit.this,app.getUser());
        lv.setAdapter(la);
