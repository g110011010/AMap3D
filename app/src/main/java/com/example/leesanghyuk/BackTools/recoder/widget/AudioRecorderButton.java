package com.example.leesanghyuk.BackTools.recoder.widget;
...
import com.example.leesanghyuk.BackTools.recoder.manager.DialogManager;
import com.example.leesanghyuk.BackTools.recoder.manager.RecorderManager;
import com.example.sf.amap3d.R;


import static com.example.leesanghyuk.LayoutDemo.TtsDemo.LIMIT_TIME;
...
//        mRecorderManager = new RecorderManager(dir);
    ...
    private void changeState(int state) {
        if (mCurState != state) {
            ...
            switch (state) {
                case STATE_NORMAL:
                    setBackgroundResource(R.drawable.play_icn_more);
                    break;
                case STATE_RECORDING:
                    setBackgroundResource(R.drawable.lay_icn_document);
                    if (isRecording) {
