...
import com.example.leesanghyuk.BackTools.recoder.manager.MediaManager;
import com.example.leesanghyuk.BackTools.recoder.model.RecorderBean;
import com.example.leesanghyuk.BackTools.recoder.widget.AudioRecorderButton;
...
//该页用于搜索，因为数据直接可以拿到，不用去数据库请求了。
public class SearchTtsDemo extends AppCompatActivity implements View.OnClickListener{
    private static String TAG = SearchTtsDemo.class.getSimpleName();
    ...
    public static final int LIMIT_TIME = 100;//指定最大录制时长
...
//    private boolean isPush;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        poet_id=getIntent().getIntExtra(SearchTtsDemo.POETRIES_ID_EXTRA,985);
        ...
        // 初始化合成对象
        mTts = SpeechSynthesizer.createSynthesizer(SearchTtsDemo.this, mTtsInitListener);
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()) {
            ...
            case R.id.ivPlayOrPause:
                ...
                else if (mDatas.size()==0&&flag) {
//				// 移动数据分析，收集开始合成事件
                    Toast.makeText(SearchTtsDemo.this, "暂无录音，自动播放讯飞语音", Toast.LENGTH_SHORT).show();
                    //读取数据库
            ...
            case R.id.comment_list:
                ...
                startActivity(new Intent(SearchTtsDemo.this, ListViewDemo.class));
    ...
    private void getPeotryInfo(int poet_id){
        String sql;
        sql="select pl.title,pl.name,pl.poetries_content from poetries_l pl where pl.id="+poet_id;
    ...
    Handler handler_for_poet=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                ...
                Intent intent=new Intent(SearchTtsDemo.this, PoetryBrownser.class);
    ...
    protected void onResume() {
        //移动数据统计分析
        FlowerCollector.onResume(SearchTtsDemo.this);
    ...
    protected void onPause() {
        ...
        FlowerCollector.onPause(SearchTtsDemo.this);
        super.onPause();
        MediaManager.pause();
    }
