 ...
 */
public class TS_Thread_NoWait extends Thread {
    ...
    public TS_Thread_NoWait(AMap aMap, List<Poetry> poetryList, int width, int height, final Activity activity, final Handler handler) {
