...
public class PoetMutipleChoice extends AppCompatActivity implements View.OnClickListener{
    private ListView mListView;
    private List<PoetMutipleModel> models;
    private CheckBox mMainCkb;
    private ImageView mMultipleChoiceBack;
    ...
    private void initView() {
        ...
        mMultipleChoiceBack=(ImageView)findViewById(R.id.multiple_chioce_back);

        mMultipleChoiceBack.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.multiple_chioce_back:
                this.finish();
                break;
        }
    }
