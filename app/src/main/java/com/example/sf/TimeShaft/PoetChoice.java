...
public class PoetChoice extends ListActivity implements View.OnClickListener{
    //    向下一个活动传递显示诗人ID的键
    public static final String POET_ID_KEY="POET_ID";
    private ImageView mChoiceBack;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.poet_choice);

        mChoiceBack= (ImageView) findViewById(R.id.chioce_back);
        mChoiceBack.setOnClickListener(this);
        mChoiceBack.setVisibility(View.VISIBLE);
