...
public class PortTimerShaft extends Activity implements View.OnClickListener {
...
//                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
        ...
        final Handler serMsgHander=new Handler(){
            ...
            public void handleMessage(Message msg){
                ...
                revorcamera();
                ts = new TS_Thread(aMap, poetries, width, height, PortTimerShaft.this,hander,true);
...
//                        poetry.setId(poetriesJson.getInt(CONSTANTS_SF.TABLE_POETRIES_L.ID));
    ...
    public void revorcamera(){
        aMap.animateCamera(CameraUpdateFactory.newLatLngBounds(new LatLngBounds(new LatLng(2.0, 72.0), new LatLng(54.0, 136.0)), 10), 1000, new AMap.CancelableCallback() {
                    @Override
